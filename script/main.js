...
let shot_sound = new Audio();
shot_sound.src = "./sounds/Shot.mp3"
// const enemy_hit_sound = new Audio("EnemyHit.mp3");
// const player_hit_sound = new Audio("PlayerHit.mp3");
// const explosion_sound = new Audio("Explosion.mp3");
